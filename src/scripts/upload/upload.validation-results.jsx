...
// life cycle events ------------------------------------------------------
    ...
    render () {
        ...
        if (errors.length > 0) {
            ...
            errorsWrap = (
                <Panel className="fade-in upload-panel error-wrap" header={errorHeader}  eventKey='1'>
        ...
        if (warnings && warnings.length > 0) {
            ...
            warningWrap = (
                <Panel className="fade-in upload-panel warning-wrap" header={warningHeader}  eventKey='2'>
