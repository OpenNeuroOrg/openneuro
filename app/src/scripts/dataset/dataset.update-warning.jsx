  ...
  render() {
    return (
      <Modal show={this.props.show} onHide={this._hide.bind(this)}>
        ...
        <Modal.Body>{this._body(this.props.update)}</Modal.Body>
      </Modal>
    )
  }
      ...
      return (
        <div className="row update-modal">
          <div className="col-xs-12">
            ...
            {this._dontShowAgain(!currentUpdate.hideDontShow)}
            <br />
            <div className="col-xs-12 modal-actions">
              <button
                className="btn-modal-submit btn-modal-danger"
                onClick={this._confirm.bind(this, currentUpdate.action)}>
                {currentUpdate.confirmTxt
                  ? currentUpdate.confirmTxt
                  : 'Confirm'}
              </button>
