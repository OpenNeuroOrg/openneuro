...
class FrontPage extends Reflux.Component {
  ...
  _error(signinError, loadingState) {
    if (signinError && !loadingState) {
      ...
      if (errMessage === 'Your ORCID account does not have an e-mail, or your e-mail is not public. Please fix your account before continuing.') {
        return (
          <div className="alert alert-danger">
            <span>Your ORCID account does not have an e-mail, or your e-mail is not public. Visit your <a href="https://orcid.org/my-orcid">ORCID profile</a> and verify your primary email privacy is set to public.</span>
          </div>
        )
      } else {
        return (
