...
let userAuth =
    'Basic ' +
    new Buffer(config.agave.username + ':' + config.agave.password).toString(
      'base64',
    ),
  clientAuth =
    'Basic ' +
    new Buffer(
      client.config.consumerKey + ':' + client.config.consumerSecret,
    ).toString('base64')
...
export default {
  ...
  deleteClient(clientName, callback) {
    request.del(
      config.agave.url + 'clients/v2/' + clientName,
      {
        headers: {
          Authorization: userAuth,
        },
      ...
      request.get(
        ...
        (err, res) => {
          this.handleResponse(
            ...
            res,
            callback,
            this.listApps.bind(this, callback),
          )
        },
      )
    })
  ...
  getApp(appId, callback) {
    this.auth(() => {
      request.get(
        config.agave.url + 'apps/v2/' + appId,
        {
          headers: {
            Authorization: 'Bearer ' + token.access,
            'Content-Type': 'application/json',
        ...
        (err, res) => {
          this.handleResponse(
            ...
            res,
            callback,
            this.getApp.bind(this, appId, callback),
          )
        },
      )
    })
      ...
      request.post(
        ...
        (err, res) => {
          this.handleResponse(
            ...
            res,
            callback,
            this.createJob.bind(this, job, callback),
          )
        },
      )
    })
      ...
      request.get(
        ...
        (err, res) => {
          this.handleResponse(
            ...
            res,
            callback,
            this.listJobs.bind(this, callback),
          )
        },
      )
    })
  ...
  getJob(jobId, callback) {
    this.auth(() => {
      request.get(
        config.agave.url + 'jobs/v2/' + jobId,
        {
          headers: {
            Authorization: 'Bearer ' + token.access,
            'Content-Type': 'application/json',
        ...
        (err, res) => {
          this.handleResponse(
            ...
            res,
            callback,
            this.getJob.bind(this, jobId, callback),
          )
        },
      )
    })
  ...
  getJobResults(jobId, callback) {
    this.auth(() => {
      request.get(
        config.agave.url + 'jobs/v2/' + jobId + '/outputs/listings/out',
        {
          headers: {
            Authorization: 'Bearer ' + token.access,
            'Content-Type': 'application/json',
        ...
        (err, res) => {
          this.handleResponse(
            ...
            res,
            callback,
            this.getJobResults.bind(this, jobId, callback),
          )
        },
      )
    })
  ...
  getJobLogs(jobId, callback) {
    this.auth(() => {
      request.get(
        config.agave.url + 'jobs/v2/' + jobId + '/outputs/listings/log',
        {
          headers: {
            Authorization: 'Bearer ' + token.access,
            'Content-Type': 'application/json',
